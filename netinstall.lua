...
-- Download manifest directly to target
local targetManifest = "/" .. target .. "/" .. manifestFile
shell.run("wget " .. baseURL .. manifestFile .. " " .. targetManifest)

-- Read manifest and build file list
local fileList = {}
local f = fs.open(targetManifest, "r")
if f then
